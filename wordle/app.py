...
PLAYER_INSTRUCTIONS = "Puedes empezar a adivinar\n"
GUESS_STATEMENT = "\nIngresa tu palabra"
ALLOWED_GUESSES = 5
    ...
    while not end_of_game:
        ...
        while len(guess) != 5 or guess in already_guessed:
            if guess in already_guessed:
                console.print("[red]Aun no has descubierto la palabra!\n[/]")
            else:
                console.print('[red]Por favor ingresa una palabra de 5 letras!\n[/]')
            guess = Prompt.ask(GUESS_STATEMENT).upper()
